...
<div class="p-2">
    <a href="{{ route('templates.create') }}" class="btn btn-primary mb-3">+ Tambah Template</a>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="{{ route('templates.preview', $design->id) }}" class="dropdown-item" target="_blank">
                                        <i class="bx bx-show"></i> Preview
                                    </a>
                                    <a href="{{ route('templates.edit', $design->id) }}" class="dropdown-item">
                                        <i class="bx bx-pencil"></i> Edit
                                    </a>
                                    <form action="{{ route('templates.destroy', $design->id) }}" method="POST" class="delete-form">
                                        @csrf
                                        @method('DELETE')
